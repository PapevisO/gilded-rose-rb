...
class TestUntitled < Test::Unit::TestCase
  ...
  def test_expirable_avalance_excitable_sustain_upgradable
  ...
  def test_expirable_gradual_degradable
  ...
  def test_expirable_sustain_upgradable_sustain
    items = [Item.new('Aged Brie', 0, 52),Item.new('Aged Brie', 2, 48)]
    GildedRose.new(items).update_quality()
